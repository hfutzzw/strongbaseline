...
def build_model(cfg, num_classes):
    ...
    #model = BFE(num_classes, cfg.MODEL.LAST_STRIDE, cfg.MODEL.PRETRAIN_PATH, cfg.MODEL.NECK, cfg.TEST.NECK_FEAT, cfg.MODEL.NAME, cfg.MODEL.PRETRAIN_CHOICE)

    #model = MGN(num_classes,pool='avg',feats=256)

    model = Pyramid(num_classes)
